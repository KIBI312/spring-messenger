...
public class FriendshipController {
    ...
    @PostMapping("/add")
    public String sendFriendRequest(Principal principal, @RequestBody String username) {
        friendshipService.sendFriendshipRequest(principal.getName(), username);   
        return "success";
    }

    @PatchMapping("/accept")
    public String acceptFriendRequest(Principal principal, @RequestBody String username){
